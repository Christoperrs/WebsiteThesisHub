...
<div class="container-fluid bg-breadcrumb">
  <div class="container text-center py-5" style="max-width: 900px">
    ...
    <ol
      ...
      data-wow-delay="0.3s">
      <li class="breadcrumb-item"><a href="index.html">Edit mahasiswa</a></li>
    </ol>
  </div>
</div>
<!-- Header End -->
    ...
    <div class="container mt-5">
      ...
      <form action="<?= base_url('mahasiswa/update/' . $mahasiswa->nim); ?>" method="post">
        <div class="mb-3">
          ...
          <input type="text" class="form-control" id="nama" name="nama" value="<?= $mahasiswa->nama; ?>"   oninput="validateTextInput(this)" required>
        </div>
        <div class="mb-3">
